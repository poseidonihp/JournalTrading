...
export const TradeSchema = z.object({
  ...
  plannedStop: z.string().nullable(),
  plannedTarget: z.string().nullable(),
...
const CreateTradeBaseSchema = z.object({
  ...
  entryPrice: decimalString.optional().nullable(),
  exitPrice: decimalString.optional().nullable(),
  plannedStop: decimalString.optional().nullable(),
  plannedTarget: decimalString.optional().nullable(),
  mae: decimalString.optional().nullable(),
  mfe: decimalString.optional().nullable(),
